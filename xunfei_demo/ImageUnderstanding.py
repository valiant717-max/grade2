...
appid = "0a9a1587"    #填写控制台中获取的 APPID 信息
api_secret = "MTk2NzZlMmQ2NjE5OTQyYzBiYmZhYzQ4"   #填写控制台中获取的 APISecret 信息
api_key ="fcee1a8ab3af7a2a57a2e95451b227c5"    #填写控制台中获取的 APIKey 信息
imagedata = open("test1.png",'rb').read()
