...
if __name__ == '__main__':
    ...
    appid = "0a9a1587"  # 控制台中获取的 APPID 信息
    api_secret = "MTk2NzZlMmQ2NjE5OTQyYzBiYmZhYzQ4"  # 控制台中获取的 APISecret 信息
    api_key = "fcee1a8ab3af7a2a57a2e95451b227c5"  # 控制台中获取的 APIKey 信息
    domain = "x1"       #控制请求的模型版本
    # 服务地址
